...
namespace WireboyPlayer
{
    public sealed unsafe class H264VideoStreamEncoder : IDisposable
    {
        ...
        public H264VideoStreamEncoder(Stream stream, int fps, Size frameSize)
        {
            ...
            _pCodecContext->width = (int)frameSize.Width;
            _pCodecContext->height = (int)frameSize.Height;
            ...
            _linesizeY = (int)frameSize.Width;
            _linesizeU = (int)frameSize.Width / 2;
            _linesizeV = (int)frameSize.Width / 2;

            _ySize = _linesizeY * (int)frameSize.Height;
            _uSize = _linesizeU * (int)frameSize.Height / 2;
        }
